...
class Orchestrator:
    ...
    def process_vulnerability(self, vulnerability, local_path, repo_url, scan):
        ...
        try:
            ...
            if confidence_score > 0.7:
                ...
                patch = self.llm_service.generate_patch(vulnerability['code_snippet'], analysis)
                print("\n--- Generated Patch ---")
                print(patch)
    ...
    def run_deep_scan(self, repo_url):
        ...
        self.run_dependency_scan(local_path)
        self.run_config_scan(local_path)
    ...
    def run_dependency_scan(self, repo_path):
    ...
    def run_config_scan(self, repo_path):
